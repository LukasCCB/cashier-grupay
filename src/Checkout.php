...
class Checkout implements Arrayable, JsonSerializable
{
    ...
    /**
     * Create a new transaction on GruPay and return a new checkout instance.
     */
    ...
    /**
     * Convert the checkout to an array compatible with `GruPay.Checkout.open`.
     */
    public function options(): array
    {
        ...
        if ($customer = $this->customer) {
            $options['customer'] = ['id' => $customer->grupay_id];
        }
    ...
    /**
     * Get the GruPay transaction data.
     */
